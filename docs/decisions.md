...
## D12: Use `ts-node` for Development, `tsc` for Final Build

| Aspect           | Detail                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Decision**     | Use `ts-node` for development and `tsc` + `node` for the final deliverable                                                                                                                                                                                                                                                                                                                                                                    |
| **Alternatives** | `tsx`, `esbuild`, `bun`                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Rationale**    | `ts-node` is the established, standard tool for running TypeScript in Node.js. It's widely used in production environments, well-documented, and has the largest community support. While `tsx` is faster for zero-config usage, `ts-node` with a `tsconfig.json` is the more conventional choice and demonstrates familiarity with standard TypeScript tooling. For the deliverable, a proper `tsc` build ensures the code compiles cleanly. |
| **Trade-off**    | Slightly more config than `tsx` (needs `tsconfig.json` for `ts-node/esm`), but this config is already required for `tsc` anyway.                                                                                                                                                                                                                                                                                                              |
